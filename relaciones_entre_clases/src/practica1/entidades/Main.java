...
/*
Desarrollar un simulador del sistema de votación de facilitadores en
EggEl sistema de votación de Egg tiene una clase llamada Alumno con los siguientes
...
public class Main {
    public static void main(String[]args) {
        ...
        simulador.imprimirListaAlumnos(simulador.simulador());
    }
}
