...
public class Main {
    public static void main(String [] args){
        ...
        do{
            ...
            System.out.println("4. Pedir N cantidad de cartas: ");
            System.out.println("5. Ver cartas ya utilizadas (Cartas del monton)");
            ...
            switch (menu){
                case 1:
                    ...
                    break;
                case 2:
                    barajaServicio.siguienteCarta(baraja, baraja.getMonton());
                    break;
                case 3:barajaServicio.cartasDisponibles(baraja);
                    break;
                case 4:barajaServicio.darCartas(baraja, sc);
                    break;
                case 5:barajaServicio.mostrarMonton(baraja);
                    break;
                case 6:barajaServicio.mostrarBaraja(baraja);
                    break;
                case 7:
