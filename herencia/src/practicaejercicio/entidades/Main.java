...
import practicaejercicio.servicios.ElectrodomesticoService;
...
public class Main {
    public static void main(String [] args){
        ElectrodomesticoService electroService = new ElectrodomesticoService();
        Electrodomestico electrodomestico = electroService.crearElectrodomestico();
